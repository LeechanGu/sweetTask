package com.leechangu.sweettask.database;
...
public class DatabaseAdapter {
    ...
    /**
     * Retrieves the details of all the users stored in the  table.
     *
     * @return
     */
    ...
    /**
     * Stores the username and password upon creation of new details.
