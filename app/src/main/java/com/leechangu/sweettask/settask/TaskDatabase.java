...
public class TaskDatabase extends SQLiteOpenHelper {
    static TaskDatabase instance = null;
    ...
    private static TaskItem getTaskFromCursor(Cursor cursor)
    {
        ...
        taskItem.setTimeBasis(TimeBasisEnum.valueOf(cursor.getString(cursor.getColumnIndex(COLUMN_REPEAT))));
    ...
    public static List<TaskItem> getAll() {
        ...
        Cursor cursor = TaskDatabase.getCursor();
